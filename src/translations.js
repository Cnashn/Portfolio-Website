  ...
  fr: {
    ...
    projects: [
      ...
      },
      {
        ...
        description:
          "Un gestionnaire de contacts full-stack et multi-utilisateur avec une API Web .NET 10 et une interface React. Authentification JWT avec isolation des données par utilisateur, groupes de contacts, téléversement de photos, suivi des anniversaires, import/export CSV avec rapport d'erreurs par ligne, et un carnet d'adresses PDF imprimable. Construit avec EF Core et SQL Server côté serveur, TypeScript, Tailwind CSS et TanStack Query côté client.",
      },
      {
